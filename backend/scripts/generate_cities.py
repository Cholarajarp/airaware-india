...
# Define the full, comprehensive list of Indian cities
FULL_CITY_LIST = [
...
def generate_cities_file():
    """Writes the full city list to cities.json."""
    DATA_DIR.mkdir(exist_ok=True)
    try:
        with open(CITIES_FILE, 'w', encoding='utf-8') as f:
            json.dump(FULL_CITY_LIST, f, indent=2, ensure_ascii=False)
        print(f"✅ Successfully generated {len(FULL_CITY_LIST)} cities in {CITIES_FILE}")
    except Exception as e:
        print(f"❌ Failed to write {CITIES_FILE}: {e}")
